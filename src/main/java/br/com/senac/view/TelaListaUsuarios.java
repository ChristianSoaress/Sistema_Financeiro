...
public class TelaListaUsuarios extends javax.swing.JFrame {
    ...
    private void btnRemoverUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverUserActionPerformed
        ...
        int idUsuario = (int) tableModel.getValueAt(linhaSelecionada, 0);
        int idUsuarioAutenticado = usuarioAutenticado.getId();
        
        if(!usuarioDAO.podeRemoverUsuario(idUsuario, idUsuarioAutenticado)){
            JOptionPane.showMessageDialog(this, "Você não pode remover a si mesmo.", "Atenção", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        int confirmacao = JOptionPane.showConfirmDialog(this, "Tem certeza que deseja remover este usuário?", "Confirmação", JOptionPane.YES_NO_OPTION);
